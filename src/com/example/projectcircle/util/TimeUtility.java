...
import com.example.projectcircle.bean.ItemBean;
...
public class TimeUtility {
    ...
    private static String JUST_NOW = MyApplication.getInstance().getString(R.string.justnow);
    private static String MIN = MyApplication.getInstance().getString(R.string.min);
    private static String HOUR = MyApplication.getInstance().getString(R.string.hour);
    private static String DAY = MyApplication.getInstance().getString(R.string.day);
    private static String MONTH = MyApplication.getInstance().getString(R.string.month);
    private static String YEAR = MyApplication.getInstance().getString(R.string.year);

    private static String YESTER_DAY = MyApplication.getInstance().getString(R.string.yesterday);
    private static String THE_DAY_BEFORE_YESTER_DAY = MyApplication.getInstance().getString(R.string.the_day_before_yesterday);
    private static String TODAY = MyApplication.getInstance().getString(R.string.today);

    private static String DATE_FORMAT = MyApplication.getInstance().getString(R.string.date_format);
