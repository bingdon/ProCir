...
import com.example.projectcircle.util.SystemMethod;
...
public class TitleBarView extends RelativeLayout {
	...
	private void initView() {
		// LayoutInflater.from(mContext).inflate(R.layout.common_title_bar,
		// this);
	...
	public void setPopWindow(PopupWindow mPopWindow, TitleBarView titleBaarView) {
		...
		setBtnRight(R.drawable.near_group_selector);
	}
