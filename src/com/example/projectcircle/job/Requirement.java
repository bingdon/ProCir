 ...
 * 司机需求列表
 */
public class Requirement extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		title.setText(R.string.driver_requirement);
...
//				job.setTel(obj.getString("tel"));
//				job.setType(obj.getString("type"));
	...
	private void initList() {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(Requirement.this, WorkDetail.class);
				intent.putExtra("jid", jobsList.get(arg2).getId());
				intent.putExtra("distance", listItem.get(arg2).get("distance")+"");
				intent.putExtra("job", "2");//1代表工程作业，Title显示工程作业信息详情界面；2.代表司机需求，Title显示司机需求信息详情
...
//			map.put("address", jobsList.get(i).getLocation());
			map.put("title", jobsList.get(i).getTitle());
//			map.put("detail", jobsList.get(i).getDetail());
//			map.put("contact", jobsList.get(i).getName());
//			map.put("tel", jobsList.get(i).getTel());
         	map.put("date", jobsList.get(i).getDate());
//			map.put("type", jobsList.get(i).getType());
	...
	public void onClick(View v) {
		...
		case R.id.project_job_right:
			Intent intent2 = new Intent(Requirement.this, AddJob.class);
