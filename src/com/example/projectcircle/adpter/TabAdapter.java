...
public class TabAdapter extends BaseAdapter {
	...
	/* 构造函数 */
	public TabAdapter(ArrayList<HashMap<String, Object>> listItem,
			Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.address.setText(arrays[0]);
		holder.sign.setText(sign);
		if(!TextUtils.isEmpty(equipment) && !equipment.equals("null")){
		holder.device.setText(equipment);
		}else{
			holder.device.setText("");	
		}
		//计算我和好友之间的距离
